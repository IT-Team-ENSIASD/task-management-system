...
import { CalendarIcon, ClockIcon, PlusIcon, SearchIcon, FilterIcon, MoreHorizontalIcon, CheckCircle2Icon, CircleIcon, ArchiveIcon, PlayCircleIcon, SparklesIcon, CheckIcon } from '../../components/icons';
...
export default function TasksPage() {
    ...
    const metricCards = useMemo(
        () => [
            { label: 'Total tasks', value: String(stats.total), iconKey: 'sparkles' as const },
            { label: 'Completed', value: String(stats.completed), iconKey: 'check' as const },
            { label: 'Due soon', value: String(stats.inProgress), iconKey: 'calendar' as const },
        ],
                                ...
                                filteredTasks.map((task) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`soft-card w-full p-4 text-left transition-all duration-200 ${isSelected
                                                ...
                                                .map((option) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`flex items-center gap-2 px-4 py-3 rounded-xl border text-sm font-medium transition-all ${isActive
                        ...
                        <div className="flex gap-2">
                            {(['low', 'medium', 'high', 'urgent'] as const).map((p) => (
                                <button
                                    ...
                                    className={`flex-1 py-2.5 px-3 rounded-xl border text-sm font-medium capitalize transition-all ${newTaskPriority === p
